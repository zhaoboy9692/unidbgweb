...
public class DeviceNative extends AbstractJni implements IOResolver {
    ...
    public DeviceNative() throws IOException {
        ...
        DalvikModule dm = vm.loadLibrary(new File("src/main/resources/app/pdd/libpdd_secure.so"), false);
    ...
    public DvmObject callObjectMethod(BaseVM vm, DvmObject dvmObject, String signature, VarArg varArg) {
        switch (signature) {
            ...
            case "android/telephony/TelephonyManager->getDeviceId()Ljava/lang/String;":
                return new StringObject(vm, this.deviceId);
