...
//美团外卖
public class waimai extends AbstractJni implements IOResolver {
    ...
    private static final String APK_PATH = "src/main/resources/app/mtwm/7.8.4.70804.apk";

    private final Module module;

    private waimai() throws IOException {
